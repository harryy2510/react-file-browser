...
export function getFileBrowserUploadCandidates(files: File[] | FileList): FileBrowserUploadCandidate[] {
...
async function collectEntryCandidates(entry: FileSystemEntryLike, prefix = ''): Promise<FileBrowserUploadCandidate[]> {
	if (entry.isFile) {
