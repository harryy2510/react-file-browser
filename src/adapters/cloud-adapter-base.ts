...
export class UnsupportedCloudFileBrowserAdapter implements FileBrowserAdapter {
  ...
  constructor(
    ...
    if (this.implementation?.createFolder) {
      this.createFolder =
        this.implementation.createFolder.bind(this.implementation);
    }
    ...
    if (this.implementation?.createMultipartUpload) {
      this.createMultipartUpload =
        this.implementation.createMultipartUpload.bind(this.implementation);
    }
    ...
    if (this.implementation?.completeMultipartUpload) {
      this.completeMultipartUpload =
        this.implementation.completeMultipartUpload.bind(this.implementation);
    }
    if (this.implementation?.abortMultipartUpload) {
      this.abortMultipartUpload =
        this.implementation.abortMultipartUpload.bind(this.implementation);
    }
    if (this.implementation?.bulkDownloadUrl) {
      this.bulkDownloadUrl =
        this.implementation.bulkDownloadUrl.bind(this.implementation);
    }
  }
